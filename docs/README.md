...
The project overview for every audience is the root [README](../README.md). Case-set homepages are [balanced](../data/case_sets/balanced/README.md) and [seed-guided](../data/case_sets/seed_guided/README.md).
