...
These files were relocated to `data/validation/legacy_pre_taxonomy/v3/` without regenerating the JSON. Do not omit `--plan` / `--output-dir`; the CLI defaults would reuse or overwrite V1.
