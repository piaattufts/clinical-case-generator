...
> Current prospective sets: [`CLINIPROOF_BALANCED_V4`](../../../case_sets/balanced/README.md) and [`CLINIPROOF_SEEDCASES_V3`](../../../case_sets/seed_guided/README.md).

**Status: archived preclinical-QC version.** This freeze is **not** an active prospective study set. Later revisions are `CLINIPROOF_BALANCED_V3` and the current set [`CLINIPROOF_BALANCED_V4`](../../../case_sets/balanced/README.md).
...
It does **not** replace archived `CLINIPROOF_TAXONOMY_V1` in [`CLINIPROOF_TAXONOMY_V1`](../CLINIPROOF_TAXONOMY_V1/). The current balanced set is [`CLINIPROOF_BALANCED_V4`](../../../case_sets/balanced/README.md). `CLINIPROOF_SEEDCASES_V1` in [`CLINIPROOF_SEEDCASES_V1`](../CLINIPROOF_SEEDCASES_V1/) is likewise a preclinical-QC archive.
