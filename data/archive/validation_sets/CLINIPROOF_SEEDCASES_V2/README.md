...
The preclinical-QC freeze `CLINIPROOF_SEEDCASES_V1` remains in [`CLINIPROOF_SEEDCASES_V1`](../CLINIPROOF_SEEDCASES_V1/). Archived `CLINIPROOF_TAXONOMY_V1` remains in [`CLINIPROOF_TAXONOMY_V1`](../CLINIPROOF_TAXONOMY_V1/). The current seed-guided set is [`CLINIPROOF_SEEDCASES_V3`](../../../case_sets/seed_guided/README.md).
