...
**Status: archived preclinical-QC version.** This freeze is **not** an active prospective study set. Later revisions are `CLINIPROOF_SEEDCASES_V2` and the current set [`CLINIPROOF_SEEDCASES_V3`](../../../case_sets/seed_guided/README.md).
...
- archived `CLINIPROOF_TAXONOMY_V1` in [`CLINIPROOF_TAXONOMY_V1`](../CLINIPROOF_TAXONOMY_V1/)
- preclinical-QC `CLINIPROOF_BALANCED_V2` in [`CLINIPROOF_BALANCED_V2`](../CLINIPROOF_BALANCED_V2/)
